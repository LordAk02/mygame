...
function checkAnswer(guess) {
  ...
  if (attempts == 3) {
    ...
    info.innerHTML =
      "<p class='retry'>Sorry babe. You are out of chances. <button id='retry-button'>Retry</button> </p>";
    reset();
  }
...
function setLevel() {
  if (level == 1) {
    ...
    openLoremPage();
function openLoremPage() {
        const newWindow = window.open("lorem-page.html", "_blank");
    }
  } else if (level == 3) {
